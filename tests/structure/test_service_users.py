...
class StructureTestSuite(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.MODULE = app.services.users

    def test_class_exists_crmusersservice(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNl").decode(),
            classes,
            msg=f"The class "
            f"`{base64.b64decode(b'Q1JNVXNlcnNTZXJ2aWNl').decode()}` "
            f"is not found, but it was marked as required.",
        )

    def test_class_function_exists_crmusersservice_get(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNl").decode(),
            classes,
        ...
        functions = _get_class_function_names(
            self.MODULE, base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNl").decode()
        )
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNlLmdldA==").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'Q1JNVXNlcnNTZXJ2aWNlLmdldA==').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'Q1JNVXNlcnNTZXJ2aWNl').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_crmusersservice_get(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNl").decode(),
            classes,
        ...
        self.assertEqual(
            base64.b64decode(b"dXNlcl9pZA==").decode(),
            args[1],
    ...
    def test_class_function_exists_crmusersservice_get_list(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNl").decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNlLmdldF9saXN0").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'Q1JNVXNlcnNTZXJ2aWNlLmdldF9saXN0').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'Q1JNVXNlcnNTZXJ2aWNl').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_crmusersservice_get_list(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"Q1JNVXNlcnNTZXJ2aWNl").decode(),
            classes,
