...
import app.client.base


class StructureTestSuite(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.MODULE = app.client.base

    def test_class_exists_simpleapiclient(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
            msg=f"The class "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50').decode()}` "
            f"is not found, but it was marked as required.",
        )

    def test_class_function_exists_simpleapiclient__call(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
        ...
        functions = _get_class_function_names(
            self.MODULE, base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode()
        )
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50Ll9jYWxs").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50Ll9jYWxs').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_simpleapiclient__call(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
        ...
        self.assertEqual(
            base64.b64decode(b"cm9vdF9hcGlfdXJs").decode(),
            args[2],
        ...
        self.assertEqual(
            base64.b64decode(b"aGVhZGVycw==").decode(),
            args[5],
        ...
        self.assertEqual(
            ...
            args[11],
            msg=f"The argument #11 of function "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50Ll9jYWxs').decode()}` "
            f"in class "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50').decode()}` "
            f"should be called "
    ...
    def test_class_function_exists_simpleapiclient__check_response(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50Ll9jaGVja19yZXNwb25zZQ==").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50Ll9jaGVja19yZXNwb25zZQ==').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_simpleapiclient__check_response(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
    ...
    def test_class_function_exists_simpleapiclient_call(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50LmNhbGw=").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50LmNhbGw=').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'U2ltcGxlQVBJQ2xpZW50').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_simpleapiclient_call(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"U2ltcGxlQVBJQ2xpZW50").decode(),
            classes,
