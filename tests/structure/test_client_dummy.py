...
import app.client.dummy


class StructureTestSuite(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.MODULE = app.client.dummy

    def test_class_exists_dummyapiclient(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQ=").decode(),
            classes,
            msg=f"The class "
            f"`{base64.b64decode(b'RHVtbXlBUElDbGllbnQ=').decode()}` "
            f"is not found, but it was marked as required.",
        )

    def test_class_function_exists_dummyapiclient__check_response(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQ=").decode(),
            classes,
        ...
        functions = _get_class_function_names(
            self.MODULE, base64.b64decode(b"RHVtbXlBUElDbGllbnQ=").decode()
        )
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQuX2NoZWNrX3Jlc3BvbnNl").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'RHVtbXlBUElDbGllbnQuX2NoZWNrX3Jlc3BvbnNl').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'RHVtbXlBUElDbGllbnQ=').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_dummyapiclient__check_response(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQ=").decode(),
            classes,
    ...
    def test_class_function_exists_dummyapiclient_call(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQ=").decode(),
            classes,
        ...
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQuY2FsbA==").decode(),
            functions,
            msg=f"The function "
            f"`{base64.b64decode(b'RHVtbXlBUElDbGllbnQuY2FsbA==').decode()}` "
            f"is not found in class "
            f"`{base64.b64decode(b'RHVtbXlBUElDbGllbnQ=').decode()}`, "
            f"but it was marked as required.",
        )

    def test_class_function_signature_match_dummyapiclient_call(self):
        classes = _get_class_names(self.MODULE)
        self.assertIn(
            base64.b64decode(b"RHVtbXlBUElDbGllbnQ=").decode(),
            classes,
